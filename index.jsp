...
<% 
    ...
    if(request.getParameter("submit")!=null)
    {
        ...
        con = DriverManager.getConnection("jdbc:mysql://localhost:3306/schooll","root","root");
...
<html>
    ...
    <body>
       ...
       <div class="container">
        <h1> Registation To Start Quiz</h1>
        </br>
        <div class="row">
            <div class="col-sm-4">
                <form  method="POST" action="quiz.html" > 
                    ...
                    <div alight="left">
                     ...
                     <div alight="right">
                        ...
                        <a class="btn btn-primary" href="vote.html" role="button">Start-Quiz</a>
